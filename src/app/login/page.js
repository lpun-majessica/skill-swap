...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-5 font-sans relative overflow-hidden">
      ...
      <div className="bg-red-600 text-white relative col-span-2 md:block hidden overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-full pointer-events-none z-20 overflow-hidden">
          <img
            src="/pfp/login-1.svg"
            alt="Pending card"
      ...
      <div className="bg-white flex justify-center relative col-span-3 md:col-span-3 dark dark:bg-[oklch(0.145_0_0)] z-0">
        <div className="absolute right-5 p-10 z-10 flex justify-between items-center w-full">
          <div className="text-left">
            <div className="p-9 font-bold md:hidden visible text-left"><Logo /></div>
          </div>
