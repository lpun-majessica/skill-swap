...
import { ChevronUp, UserRoundPlus } from "lucide-react";
...
export function ConnectedButton() {
	return (
		<Popover>
			...
			>
				Connected <ChevronUp className="size-4 rotate-180" />
			</PopoverTrigger>
			<PopoverContent className="p-2 size-fit bg-stone-100 dark:bg-stone-600">
				<Button className="w-35 text-xs lg:w-40 lg:text-sm bg-transparent text-stone-700 hover:bg-red-200 dark:hover:bg-red-400/70 dark:text-stone-200">
					Remove connection
				</Button>
			</PopoverContent>
		</Popover>
	...
	return (
		<Popover>
			<PopoverTrigger
				className={`${sharedClass} flex flex-row justify-center items-center gap-1 bg-stone-200/90 border-2 border-stone-300 text-stone-700 hover:bg-stone-300/80 hover:cursor-pointer dark:bg-stone-700/90 dark:hover:bg-stone-600/80 dark:border-stone-600/70 dark:text-stone-200`}
			>
				Pending <ChevronUp className="size-4 rotate-180" />
			</PopoverTrigger>
			<PopoverContent className="p-2 size-fit bg-stone-100  dark:bg-stone-600">
				<Button className="w-35 text-xs lg:w-40 lg:text-sm bg-transparent text-stone-700  hover:bg-red-200 dark:hover:bg-red-400/70 dark:text-stone-200">
					Cancel request
