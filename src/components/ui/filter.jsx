    ...
    <>
      ...
      <div className="flex flex-col overflow-y-auto pr-1 sm:pr-2 space-y-2">
        ...
        <div className="grid grid-cols-[3.5fr_1fr_1fr] gap-1 sm:gap-2 px-1 sm:px-2 py-2 sticky top-0 bg-white dark:bg-ss-black-929 z-10">
          <div className="text-base font-semibold text-left text-black dark:text-white">Skills</div>
          <div className="text-sm  text-center text-gray-300 dark:text-gray-200">Teach</div>
          <div className="text-sm   text-center text-gray-300 dark:text-gray-200">Learn</div>
        </div>
